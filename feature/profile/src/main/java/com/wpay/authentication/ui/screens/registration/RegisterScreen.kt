...
fun AgreementText() {
    ...
    Row(
        ...
        Checkbox(
            ...
            colors = CheckboxDefaults.colors(checkedColor = primaryTextColor),
        )
...
fun BottomTextSection(
    ...
    Column(
        ...
        RegisterButtonWithIcon(onClick = onBtnClick, btnText = btnText)
...
@Composable
fun RegisterButtonWithIcon(onClick: () -> Unit, btnText: String) {
    Button(
        onClick = onClick,
